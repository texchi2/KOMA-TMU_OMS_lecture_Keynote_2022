...
Textbook: "Dental Terminology" \footnotesize{(\url{shorturl.at/hoxN7})}
}
% {shorturl.at/iqG18}
...
\clearpage
%%
\noindent forceps (FOUR-seps)\\
scalpel handle and scalpel\\
bone file\\%[3mm]
%periosteal elevators\\%[3mm]
curette\\
...
\includegraphics[width=5.0cm]{8272E96F-2F4C-4CA3-819B-C93D7E515B20.jpeg}
%\begin{figure}[!htb]
%    \centering
    \begin{tikzpicture}
...
\begin{minipage}[c]{0.35\linewidth}
    ...
    \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (image) at (0.0,0) {\includegraphics[width=8.0cm]{Biopsy.pdf}};
    \node[anchor=south west,inner sep=0] (image) at (0.5 
    ,-1.7) {\includegraphics[width=1.0cm]{no10.png}};
    \end{tikzpicture}
\end{minipage}
